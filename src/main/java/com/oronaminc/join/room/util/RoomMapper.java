...
public class RoomMapper {
    ...
    public static RoomDetailResponse toRoomDetailResponse(Room room, Participant presenter, List<Participant> team, String presignedUrl, Long memberId, int participantCount) {
